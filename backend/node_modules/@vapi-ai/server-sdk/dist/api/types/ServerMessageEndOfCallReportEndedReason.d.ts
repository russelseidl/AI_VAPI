...
export declare const ServerMessageEndOfCallReportEndedReason: {
    ...
    readonly AssistantNotInvalid: "assistant-not-invalid";
    ...
    readonly PipelineErrorDeepgram403ModelAccessDenied: "pipeline-error-deepgram-403-model-access-denied";
    readonly PipelineErrorDeepgram404NotFound: "pipeline-error-deepgram-404-not-found";
    readonly PipelineErrorDeepgram400NoSuchModelLanguageTierCombination: "pipeline-error-deepgram-400-no-such-model-language-tier-combination";
    readonly PipelineErrorDeepgram500ReturningInvalidJson: "pipeline-error-deepgram-500-returning-invalid-json";
